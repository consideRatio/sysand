...
public class BasicTest {
    ...
    public void testBasicEnv() {
        try {
            ...
            assertTrue(Files.exists(envPath.resolve("env.toml")), "env.toml file should exist");
            String env_toml = new String(Files.readAllBytes(envPath.resolve("env.toml")));
            assertEquals("# This file is automatically generated by Sysand and is not intended to be edited manually.\n\nversion = \"0.1\"\n", env_toml);
        } catch (java.io.IOException e) {
