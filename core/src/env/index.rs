...
//! `design/index-protocol.md` for the wire format and the authority
...
//! - The wire contract is kept in `design/index-protocol.md`; the code
...
/// "project not in this index" 404 outcome (§8) is not currently
/// cached.
